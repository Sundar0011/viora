...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF264AFF);
  ...
  late Color extraBlack = const Color(0xFF0C0C0C);
  late Color primaryD3 = const Color(0xFF1B35B5);
  late Color pageBack = const Color(0xFFF7F9FC);
  late Color white = const Color(0xFFFFFFFF);
  late Color greenColor1 = const Color(0xFF0F8849);
  ...
  late Color primaryD4 = const Color(0xFF2343E8);
  late Color tertiaryL1 = const Color(0xFFE9F9F8);
  late Color customColor1 = const Color(0xFFB3B665);
  late Color primaryL1 = const Color(0xFFE9EDFF);
  late Color redColor2 = const Color(0xFFE03616);
  late Color greenColor2 = const Color(0xFF00AF54);
  late Color greyD1 = const Color(0xFF494949);
  late Color secondaryNormal = const Color(0xFFFF4C4C);
  late Color shimmerColor = const Color(0x170C0C0C);
}
