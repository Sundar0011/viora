                ...
                if (!_model.showData)
                  Expanded(
                    child: RefreshIndicator(
                      ...
                      // Re-runs exactly the page-load fetch from initState, so a
                      // pull-to-refresh returns genuinely fresh business data on
                      ...
                      onRefresh: () async {
                        ...
                        // Also drops the cached "contacted" request so its
                        // FutureBuilder re-queries with the rest of the page.
                        safeSetState(() => _model.apiRequestCompleter = null);
                        await _model.waitForApiRequestCompleted();
                      },
                      child: SingleChildScrollView(
                        // Required, otherwise the pull gesture never reaches the
                        // RefreshIndicator when the page content is short.
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  await launchUrl(Uri(
                                                      ...
                                                      query: {
                                                        'subject':
                                                            'Hi , I saw your Business in Flock',
                                                      }
                                                          .entries
                                                          .map((MapEntry<String,
                                                                      String>
