...
import 'comp_delete_business_model.dart';
export 'comp_delete_business_model.dart';

class CompDeleteBusinessWidget extends StatefulWidget {
  const CompDeleteBusinessWidget({
    super.key,
  ...
  @override
  State<CompDeleteBusinessWidget> createState() =>
      _CompDeleteBusinessWidgetState();
}

class _CompDeleteBusinessWidgetState extends State<CompDeleteBusinessWidget> {
  late CompDeleteBusinessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompDeleteBusinessModel());
  }
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                'Customers won’t be able to interact with your business.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.manrope(
