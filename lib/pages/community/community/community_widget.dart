...
class _CommunityWidgetState extends State<CommunityWidget> {
  ...
  /// Pull-to-refresh handler: re-fetches the groups list from the backend and
  /// forces every event / business FutureBuilder on this page to re-query.
  Future<void> _refreshCommunity() async {
    await actions.fetchGroupsWithStatusRealtime();
    if (!mounted) {
      return;
    }
    // Nulling the completers makes the event FutureBuilders re-issue their
    // queries; the rebuild itself re-issues the business pages API call.
    safeSetState(() {
                              ...
                              MergeSemantics(
                                child: Semantics(
                                  ...
                                  child: InkWell(
                                    ...
                                    // Own-avatar gets the Sunrise gradient ring
                                    // affordance (design spec §5, Avatars).
                                    // Shared top-bar avatar spec - keep in sync with
                                    // home/notification/sale.
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Stack(
                                                                          ...
                                                                          children: [
                                                                            ClipRRect(
                                                                              ...
                                                                              child: AppNetworkImage(
                                                                                url: latestEventGridViewEventPageRow.coverImage,
                                                                                width: double.infinity,
                                                                                height: 120.0,
                                                                                fit: BoxFit.cover,
                                                                                semanticLabel: '${latestEventGridViewEventPageRow.name} cover photo',
                                                                              ),
                                                                            ),
                                                                            if (functions.endSoon(latestEventGridViewEventPageRow.endDateTime!))
                                                                              Padding(
                                                                        ...
                                                                        if (latestEventGridViewEventPageRow.adminUser !=
                                                                            currentUserUid)
                                                                          Stack(
                                                                            children: [
                                                                              FFButtonWidget(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    AppIconButton(
                                                                      icon: Icons
                                                                          .arrow_forward,
                                                                      semanticLabel:
                                                                          'See all events ending soon',
                                                                      onTap:
                                                                          () async {
                                                                        context.pushNamed(
                                                                            EndingEventWidget.routeName);
                                                                      },
                                                                      iconSize:
                                                                          24.0,
                                                                      color: FlutterFlowTheme.of(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Stack(
                                                                          ...
                                                                          children: [
                                                                            ClipRRect(
                                                                              borderRadius: BorderRadius.circular(2.0),
                                                                              child: AppNetworkImage(
                                                                                url: endingEventGridViewEventPageRow.coverImage,
                                                                                width: double.infinity,
                                                                                height: 120.0,
                                                                                fit: BoxFit.cover,
                                                                                semanticLabel: '${endingEventGridViewEventPageRow.name} cover photo',
                                                                              ),
                                                                            ),
                                                                            if (functions.endSoon(endingEventGridViewEventPageRow.endDateTime!))
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 0.0, 8.0),
                                                                                child: ClipRRect(
                                                                                  borderRadius: BorderRadius.circular(4.0),
                                                                        ...
                                                                        if (endingEventGridViewEventPageRow.adminUser !=
                                                                            currentUserUid)
                                                                          Stack(
                                                                            children: [
                                                                              FFButtonWidget(
                                                                        ...
                                                                        ClipRRect(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            fit:
                                                                                BoxFit.cover,
                                                                            semanticLabel:
                                                                                '${allEventsListViewEventPageRow.name} cover photo',
                                                                          ),
                                                                        ),
                                                                        Expanded(
                                                                          child:
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return Builder(
                                          builder: (context) {
                                            ...
                                            // Designed empty state instead of a
                                            // blank tab when there are no pages.
                                            if (business.isEmpty) {
                                              return EmptyState(
                                                icon: Icons.storefront_outlined,
                                                title: 'No pages yet',
                                                body:
                                                    'Local businesses and community pages will show up here once they join your neighbourhood.',
                                              );
                                            }
