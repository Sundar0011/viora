...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  /// Re-fetches the neighbourhood feed. Shared by pull-to-refresh and by the
  /// error state's Retry button so both paths do exactly the same work.
                              ...
                              children: [
                                AppIconButton(
                                  ...
                                  iconWidget: ExcludeSemantics(
                                    child: custom_widgets.GradientAvatarRing(
                                      diameter: 38.0,
                                      ringWidth: 2.0,
                                ...
                                Expanded(
                                  child: MergeSemantics(
                                    child: Semantics(
                                      button: true,
                                      label: 'Search posts and neighbours',
                                      child: InkWell(
                                        splashColor:
                                    ...
                                    children: [
                                      Builder(
                                        builder: (context) {
                                          ...
                                          return AsyncStateView<List<dynamic>>(
                                            data: posts,
                                            error: (_model.post1 != null &&
                                                    !_model.post1!.succeeded)
                                                ? 'Feed request failed'
                                                : null,
                                            onRetry: _reloadFeed,
                                            // Keeps the existing feed artwork
                                            // and adds the missing CTA so a new
                                            // user in a quiet neighbourhood has
                                            // somewhere to go.
                                            emptyBuilder: (context) =>
                                              ...
                                              title:
                                                  'No posts yet in your neighbourhood',
                                              body:
                                                  'Be the first to say hello — share something with the neighbours near you.',
                                              actionLabel:
                                                                  ...
                                                                  children: [
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children:
                                                                                [
                                                                              custom_widgets.GradientAvatarRing(
                                                                                diameter: 38.0,
                                                                                child: AppNetworkImage(
                                                                                  url: getJsonField(
                                                                                    postsItem,
                                                                                  ...
                                                                                  fit: BoxFit.cover,
                                                                                  fallbackIcon: Icons.person_rounded,
                                                                                  semanticLabel: 'Profile photo of ' + getJsonField(postsItem, r'''$.user_name''').toString(),
                                                                                ),
                                                                              ),
                                                                              Column(
                                                                                mainAxisSize: MainAxisSize.max,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        AppIconButton(
                                                                          semanticLabel:
                                                                              'Follow or unfollow ' + getJsonField(postsItem, r'''$.user_name''').toString(),
                                                                          minTapTarget:
                                                                              44.0,
                                                                          enableHaptic:
                                                                              false,
                                                                  ...
                                                                  children: [
                                                                    if (((getJsonField(
                                                                      ...
                                                                      AppNetworkImage(
                                                                        ...
                                                                        semanticLabel:
                                                                            'Photo in post by ' +
                                                                                getJsonField(postsItem, r'''$.user_name''').toString(),
                                                                      ),
                                                                    if (((getJsonField(
                                                                              postsItem,
                                                                              r'''$.post_images''',
                                                              ...
                                                              children: [
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    AppIconButton(
                                                                      semanticLabel: 'Like, ' +
                                                                          valueOrDefault<String>(
                                                                              getJsonField(postsItem, r'''$.likes_count''')?.toString(),
                                                                              '0') +
                                                                          ' likes',
                                                                      minTapTarget:
                                                                          44.0,
                                                                    ...
                                                                    AppIconButton(
                                                                      semanticLabel: 'View who liked this post, ' +
                                                                          valueOrDefault<String>(
                                                                              getJsonField(postsItem, r'''$.likes_count''')?.toString(),
                                                                              '0') +
                                                                          ' likes',
                                                                ...
                                                                AppIconButton(
                                                                  semanticLabel: 'Comments, ' +
                                                                      valueOrDefault<
                                                                              String>(
                                                                          getJsonField(postsItem, r'''$.comment_count''')
                                                                              ?.toString(),
                                                                          '0') +
                                                                      ' comments',
                                                                  minTapTarget:
                                                                ...
                                                                AppIconButton(
                                                                  semanticLabel: 'Share, ' +
                                                                      valueOrDefault<
                                                                              String>(
                                                                          getJsonField(postsItem, r'''$.share_count''')
                                                                              ?.toString(),
                                                                          '0') +
                                                                      ' shares',
                                                                  minTapTarget:
