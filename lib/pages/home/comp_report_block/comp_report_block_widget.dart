...
import 'comp_report_block_model.dart';
export 'comp_report_block_model.dart';

class CompReportBlockWidget extends StatefulWidget {
  const CompReportBlockWidget({
    super.key,
  ...
  @override
  State<CompReportBlockWidget> createState() => _CompReportBlockWidgetState();
}

class _CompReportBlockWidgetState extends State<CompReportBlockWidget> {
  late CompReportBlockModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompReportBlockModel());
                                ...
                                onPressed: () async {
                                  ...
                                  if (_model.radioButtonValue ==
                                    ...
                                    await ReportsTable().insert({
                                      'community_id': 1,
                                      'reported_by_user':
                                          widget!.blockedByUserId,
                                      'reported_user': widget!.blockedUserId,
