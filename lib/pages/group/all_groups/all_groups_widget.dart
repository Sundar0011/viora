...
import 'all_groups_model.dart';
export 'all_groups_model.dart';

class AllGroupsWidget extends StatefulWidget {
  const AllGroupsWidget({super.key});

  static String routeName = 'AllGroups';
  static String routePath = 'allGroups';
...
class _AllGroupsWidgetState extends State<AllGroupsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllGroupsModel());
  }
                              ...
                              replacement: ListView(
                                ...
                                children: [
                                  EmptyState(
                                    ...
                                    title: 'No groups to explore yet',
                                    body:
                                        'New neighbourhood groups will show up here. Pull down to refresh.',
                                  ),
                                ],
                              ),
                              child: Builder(
