...
class _CreateEventWidgetState extends State<CreateEventWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().ChoosedStartEventDate = null;
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                          ...
                          children: [
                            Stack(
                              children: [
                                ...
                                if (_model.uploadedLocalFile_eventImage !=
                                        null &&
                                    (_model.uploadedLocalFile_eventImage.bytes
                                            ?.isNotEmpty ??
                                        false))
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(0.0),
                                    child: Image.memory(
                                      _model.uploadedLocalFile_eventImage
                                              .bytes ??
                                          Uint8List.fromList([]),
                                      width: double.infinity,
                                      height: 240.0,
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                          .isDataUploading_eventImage = true);
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_eventImage =
                                            false;
                                      }
                      ...
                      if ((_model.showImageError == true) &&
                          (_model.uploadedLocalFile_eventImage == null ||
                              (_model.uploadedLocalFile_eventImage.bytes
                                      ?.isEmpty ??
                                  true)))
                        Padding(
                        ...
                        children: [
                                      ...
                                      () async {
                                        if (_model.radioButtonValue ==
                                          ...
                                          if (_model.textController2.text ==
                                            ...
                                            _model.link2 =
                                                await actions.validateMeetLink(
                                              _model.textController2.text,
                                            );
                                            if (_model.link2!) {
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              if ((_model.showStartDateError == true) &&
                                  (FFAppState().ChoosedStartEventDate == null))
                                Text(
                                        ...
                                        if (_model.radioButtonValue != null &&
                                          ...
                                          if ((_model.choosedPlace != null &&
                                            ...
                                            if (FFAppState()
                                                    .ChoosedStartEventDate !=
                                                null) {
                                              _model.showStartDateError = false;
                                              safeSetState(() {});
                                              if (_model.formKey3
                                                          .currentState ==
                                                      null ||
                                                ...
                                                if ((_model.link == true) ||
...

                                                  {
                                                    ...
                                                    try {
                                                      ...
                                                      _model.isDataUploading_eventimage1 =
                                                          false;
                                                    }
                                                    if (selectedUploadedFiles
                                                        ...
                                                        downloadUrls.length ==
                                                            selectedMedia
                                                                .length) {
                                                      safeSetState(() {
                                                        _model.uploadedLocalFile_eventimage1 =
                                                            selectedUploadedFiles
                                                                .first;
                                                        _model.uploadedFileUrl_eventimage1 =
                                                            downloadUrls.first;
                                                      });
                                                    } else {
                                                      safeSetState(() {});
                                                  ...
                                                  await EventPageTable().update(
                                                    data: {
                                                      'cover_image': _model
                                                          .uploadedFileUrl_eventimage1,
                                                    },
                                                    matchingRows: (rows) =>
                                                        rows.eqOrNull(
                                                      'id',
                                              ...
                                              _model.showStartDateError = true;
                                              safeSetState(() {});
                                              if (_model.formKey3
                                                          .currentState ==
                                                      null ||
