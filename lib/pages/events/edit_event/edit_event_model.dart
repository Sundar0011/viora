...
class EditEventModel extends FlutterFlowModel<EditEventWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in EditEvent widget.
  List<EventPageRow>? row2;
  bool isDataUploading_editEventImage = false;
  FFUploadedFile uploadedLocalFile_editEventImage =
  ...
  bool? link9;
  bool isDataUploading_eventimage2 = false;
  FFUploadedFile uploadedLocalFile_eventimage2 =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_eventimage2 = '';

  // Stores action output result for [Backend Call - Update Row(s)] action in Button widget.
  List<EventPageRow>? cover;
  // Stores action output result for [Backend Call - API (UpdateEventLocation)] action in Button widget.
  ApiCallResponse? locati;
