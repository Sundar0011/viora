                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: RefreshIndicator(
                              color: FlutterFlowTheme.of(context).primary,
                              // Clearing both completers drops the cached event
                              // and attending queries, so the FutureBuilders
                              // below issue real new requests; awaiting the
                              // helpers keeps the spinner up until they land.
                              onRefresh: () async {
                                safeSetState(() {
                              ...
                              child: SingleChildScrollView(
                                ...
                                // reaches the RefreshIndicator on short lists.
                                                          ...
                                                          return Column(
                                                            ...
                                                            children: [
                                                              if ((_model.opt ==
                                                                  ...
                                                                  ((_model.opt ==
                                                                          'invitations') &&
                                                                      ((columnEventAttendingRow?.eventId == allEventsListViewEventPageRow.id) &&
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children:
                                                                              [
                                                                            AppNetworkImage(
                                                                              url: allEventsListViewEventPageRow.coverImage,
                                                                              width: 120.0,
                                                                              height: 120.0,
                                                                              fit: BoxFit.cover,
                                                                              borderRadius: BorderRadius.circular(2.0),
                                                                              semanticLabel: 'Cover photo for ${allEventsListViewEventPageRow.name}',
                                                                            ),
                                                                            Expanded(
                                                                              child: Column(
                                                                                mainAxisSize: MainAxisSize.max,
