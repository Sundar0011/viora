...
class ListingDetailsWidget extends StatefulWidget {
  ...
  final List<FFUploadedFile>? uploadFiles;
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.uploadedFiles =
          widget!.uploadFiles!.toList().cast<FFUploadedFile>();
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SaleCategoryRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SaleCategoryRow> listingDetailsSaleCategoryRowList =
            snapshot.data!;
                      ...
                      Container(
                        ...
                        child: Stack(
                          children: [
                            ...
                            if (_model.uploadedFiles.length > 1)
                              Container(
                                width: double.infinity,
                                height: double.infinity,
                                child: Builder(
                            ...
                            if (_model.uploadedFiles.length == 1)
                              Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.memory(
                                    _model.uploadedFiles.firstOrNull?.bytes ??
                                        Uint8List.fromList([]),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          safeSetState(() => _model
                                                  .isDataUploading_uploadDataGq21 =
                                              true);
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_uploadDataGq21 =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              selectedMedia.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFiles_uploadDataGq21 =
                                                  selectedUploadedFiles;
                                            });
                                          } else {
                                            safeSetState(() {});
                                        ...
                                        if ((_model
                                                .uploadedLocalFiles_uploadDataGq21
                                                .isNotEmpty) ==
                                            true) {
                                          _model.imageSet = false;
                                          safeSetState(() {});
                                          _model.uploadedFiles = _model
                                              .uploadedLocalFiles_uploadDataGq21
                                              .toList()
                                              .cast<FFUploadedFile>();
                                          safeSetState(() {});
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    options: List<String>.from(
                                        listingDetailsSaleCategoryRowList
                                            .map((e) => e.id)
                                            .toList()),
                                    optionLabels:
                                        listingDetailsSaleCategoryRowList
                                ...
                                children: [
                                  ...
                                  FlutterFlowRadioButton(
                                    ...
                                    onChanged: (val) async {
                                      ...
                                      safeSetState(() {});
                                      if (_model.radioButtonValue == 'Free') {
                                        safeSetState(() {
                                          ...
                                          if (_model.dropDownValue != null &&
                                            ...
                                            if ((_model.uploadedFiles
                                              ...
                                              if (_model.choosedPlace != null &&
                                                ...
                                                await actions.uploadSalesImages(
                                                  _model.uploadedFiles.toList(),
                                                  getJsonField(
                                                    (_model.insert1?.jsonBody ??
                                                        ''),
                                                    r'''$.id''',
                                                  ).toString(),
                                                  currentUserUid,
                                                ...
                                                await UpdateSaleCountCall.call(
                                                  pUserid: currentUserUid,
                                                  token: currentJwtToken,
                                                );
