...
import 'listing_details_no_photos_model.dart';
export 'listing_details_no_photos_model.dart';

class ListingDetailsNoPhotosWidget extends StatefulWidget {
  const ListingDetailsNoPhotosWidget({super.key});

  static String routeName = 'ListingDetailsNoPhotos';
  static String routePath = 'listingDetailsNoPhotos';

  @override
  State<ListingDetailsNoPhotosWidget> createState() =>
      _ListingDetailsNoPhotosWidgetState();
}

class _ListingDetailsNoPhotosWidgetState
    extends State<ListingDetailsNoPhotosWidget> {
  late ListingDetailsNoPhotosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListingDetailsNoPhotosModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SaleCategoryRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SaleCategoryRow> listingDetailsNoPhotosSaleCategoryRowList =
            snapshot.data!;
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    options: List<String>.from(
                                        listingDetailsNoPhotosSaleCategoryRowList
                                            .map((e) => e.id)
                                            .toList()),
                                    optionLabels:
                                        listingDetailsNoPhotosSaleCategoryRowList
