...
class _UserProfileWidgetState extends State<UserProfileWidget> {
  ...
  /// First load: fetch the page data, then attach the realtime follows listener.
  Future<void> _initialLoad() async {
    try {
      _loadError = null;
      await _fetchProfileData();
      await _subscribeToFollows();
    } catch (e) {
      _loadError = e;
    }
  ...
  /// Fetches every server value this screen renders (neighbours, counts, posts).
  ...
  /// Re-downloads the shared post feed this screen filters its own posts from.
  ...
  /// Subscribes once to realtime follow changes so the counts stay live.
  Future<void> _subscribeToFollows() async {
  ...
  /// Pull-to-refresh handler: re-fetches the profile data and the post feed.
                                            ...
                                            builder: (context) {
                                              ...
                                              if (posts.isEmpty) {
                                                return EmptyState(
                                                  ...
                                                  title: 'No posts yet',
                                                  body:
                                                      'Anything you post to your neighbourhood will show up here.',
                                                                    ...
                                                                    Stack(
                                                                      children: [
                                                                        ...
                                                                        if (((getJsonField(
                                                                          ...
                                                                          CompPageviewWidget(
                                                                            key:
                                                                                Key('Keysw4_${postsIndex}_of_${posts.length}'),
                                                                            images:
                                                                                getJsonField(
                                                                              postsItem,
                                                                              r'''$.post_images''',
