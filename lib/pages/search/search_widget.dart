...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  /// The result sections the "All" tab can render, in display order.
  static const List<String> _kSearchSections = <String>[
    r'$.groups',
    r'$.events',
    r'$.nearby_users',
    r'$.sales',
  ...
  /// True once a search response has arrived and it holds no results at all.
  /// Returns false while `SearchData` is still null so the empty state never
  /// flashes over a query that is still in flight.
  bool _searchHasNoResults() {
    if (FFAppState().SearchData == null) {
      return false;
    }
    for (final String path in _kSearchSections) {
      if (getJsonField(FFAppState().SearchData, path).toString() != 'null') {
        return false;
      }
    }
    return true;
  ...
  /// Pull-to-refresh handler: re-runs the current query with the active filter
  /// chip and forces the per-tab FutureBuilders to re-query.
  Future<void> _refreshSearch() async {
    final ApiCallResponse response = await GetAllSearchCall.call(
    ...
    if (response.succeeded) {
      FFAppState().SearchData = response.jsonBody;
    }
    safeSetState(() {
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            ClipRRect(
                                                                              ...
                                                                              child: AppNetworkImage(
                                                                                url: SpecificGroupCall.profilepicture(
                                                                ...
                                                                return Column(
                                                                  ...
                                                                  children: [
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              Container(
                                                                                ...
                                                                                child: AppNetworkImage(
                                                                                  ...
                                                                                  fit: BoxFit.cover,
                                                                                  fallbackIcon: Icons.person_rounded,
                                                                                  semanticLabel: 'Neighbour profile photo',
                                                                                ),
                                                                              ),
                                                                              Column(
                                                                                mainAxisSize: MainAxisSize.max,
                                                                    ...
                                                                    .fadeIn(
                                                                        duration: 260
                                                                            .ms,
                                                                        delay: (40 * (neighbourhoodDataIndex % 8))
                                                                            .ms)
                                                                    .slideY(
                                                                        begin:
                                                                            0.06,
                                                                                  ...
                                                                                  children: [
                                                                                    Container(
                                                                                      ...
                                                                                      child: AppNetworkImage(
                                                                                        ...
                                                                                        fit: BoxFit.cover,
                                                                                        fallbackIcon: Icons.person_rounded,
                                                                                        semanticLabel: 'Author profile photo',
                                                                                      ),
                                                                                    ),
                                                                                    Column(
                                                                                      mainAxisSize: MainAxisSize.max,
                                      ...
                                      if (_searchHasNoResults())
                                        Padding(
                                          ...
                                          child: EmptyState(
                                            ...
                                            body:
                                                'Nothing matched "${_model.textController.text}". Try a different keyword, check the spelling, or clear your filters.',
                                          ),
                                        ),
                                                                        ...
                                                                        MergeSemantics(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              highlightColor: Colors.transparent,
                                                                              onTap: () async {
                                                                                _model.addlike222 = await AddLikeCall.call(
                                                                                  pCommunityid: FFAppState().communityId.toString(),
                                                                                  pUserid: currentUserUid,
                                                                                  pPostid: getJsonField(
                                                                                    postsItem,
                                                                        ...
                                                                        children: [
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                              ...
                                                                              _model.apiResultrykremmm = await UpdateEventAttendeeCountCall.call(
                                                                                token: currentJwtToken,
                                                                                eventId: containerEventAttendingRow?.id,
                                                                              );
                              ...
                              children: [
                                ...
                                FutureBuilder<List<SearchHistoryRow>>(
                                  future: (_model.requestCompleter ??=
                                          Completer<List<SearchHistoryRow>>()
                                            ..complete(
                                                SearchHistoryTable().queryRows(
                                              queryFn: (q) => q
                                                  .eqOrNull(
                                                    'community_id',
                                                    FFAppState().communityId,
